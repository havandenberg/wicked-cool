  ...
  <PageContent>
    ...
    <TopContentWrapper spaceBetween mb={[spacing.xl, spacing.xl]}>
      <TopContent fontSize={fontSizes.largeText} mr={[0, spacing.xxl]}>
        Keep your business running efficiently with refrigeration repair from Wicked
        Cool Refrigeration in Laconia, New Hampshire. From refrigeration units,
        icemakers, and air conditioners, to wine chillers, flower coolers, and more,
        we've got you covered. You name it, we service it!
      </TopContent>
    ...
    <Content fontSize={fontSizes.largeText} mb={[spacing.xl, spacing.xxxxxl]}>
      Keeping your commercial refrigeration units in excellent condition is critical
      for your business. Our professionals install and repair all major brands of
      commercial refrigeration units, ensuring that your new units are installed
      properly and perform optimally. We service Lakes Region's hotels, convenience
      stores, restaurants, delis, coffee shops, and more.
      <l.Space mt={[spacing.ml, spacing.xl]}/>
      A faulty coil can burn out an entire motor, costing you thousands in time and
      money to repair or replace. When your unit is making unusual sounds, not
      maintaining consistent temperature, dripping, or freezing unusually, call us
      immediately!
      <l.Space mt={[spacing.ml, spacing.xl]}/>
      Our technicians service walk-in refrigerations and freezers, commercial ice
