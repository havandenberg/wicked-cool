...
export const Heading = styled(t.H2)({color: colors.darkBlue, fontWeight: 500});
  ...
  <PageContent>
    ...
    <l.Row columnOnMobile spaceBetween mb={[spacing.xl, spacing.xl]}>
      ...
      <TopContent fontSize={fontSizes.largeText} ml={[0, spacing.xxl]}>
        Keep your systems in efficient condition with commercial air conditioning repair
        from Wicked Cool Refrigeration in Laconia, New Hampshire. Our company provides
        reliable service, maintenance, and installation for both rooftop units and split
        systems.
      </TopContent>
    </l.Row>
    ...
    <Content fontSize={fontSizes.largeText} mb={[spacing.xl, spacing.xxxxxl]}>
      ...
      freeze up, or freeze up a little here and there. You should call a professional
      immediately. Our company can often save you time and money by fixing a minor
      problem in your equipment before it escalates. Additionally, we provide proper
      installation of new units for safety and efficiency.
      <l.Space mt={[spacing.ml, spacing.xl]}/>
      Make sure to examine your equipment to ensure it is the right equipment for your
      building. When you work with our company, we make sure you have the proper
      ventilation for good air circulation and unit efficiency. Our experts specialize
