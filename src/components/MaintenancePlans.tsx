  ...
  <PageContent>
    ...
    <l.Row columnOnMobile spaceBetween mb={[spacing.ml, spacing.xxl]}>
      ...
      <TopContent fontSize={fontSizes.largeText} ml={[0, spacing.xxl]}>
        Save money on your appliances with refrigeration maintenance from Wicked Cool Refrigeration. Proper maintenance is the best way to ensure your equipment performs at its best, and to detect or prevent future problems that lead to costly damage.
      </TopContent>
    </l.Row>
    <Content fontSize={fontSizes.largeText} mb={[spacing.xl, spacing.xxl]}>
      Our company offers scheduled preventative maintenance on individual units and entire commercial kitchen refrigeration units and air conditioners. We design a service plan to fit your specific needs, just call or schedule service with us anytime.
    </Content>
